...
class RSSFeed {
    ...
    struct Item: Codable, Identifiable {
        ...
        struct Enclosure: Codable {
            ...
            init(_ enclosure: FeedKit.RSSFeedItemEnclosure?) {
                self.url = enclosure?.attributes?.url
        ...
        init(_ feedItem: FeedKit.RSSFeedItem?) {
            ...
            self.dublinCore = DublinCore(feedItem?.dublinCore)
            self.content = Content(feedItem?.content)
            self.itunes = iTunesNamespace(feedItem?.iTunes)
    ...
    struct Syndication: Codable {
        ...
        enum UpdatePeriod: String, Codable {
    ...
    struct iTunesNamespace: Codable {
